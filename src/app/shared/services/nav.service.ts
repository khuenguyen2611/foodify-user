    ...
    MENUITEMS: Menu[] = [
        {
            title: 'home', type: 'sub', active: false, children: [
                ...
                // 	]
                // },
                {path: '/home', title: 'shop', type: 'link'},
            ...
            title: 'Features', type: 'sub', megaMenu: true, badge: true, badgeText: 'new', active: false, children: [
                ...
                // },
                {
                    title: 'add-to-cart', type: 'sub', active: false, children: [
                        {path: '/home', title: 'cart-right', type: 'link'}
                ...
                // },
                {
                    title: 'email-template', type: 'sub', active: false, children: [
                        {
                            path: 'http://themes.pixelstrap.com/multikart/front-end/email-order-success.html',
                            title: 'order-success',
                            type: 'extTabLink'
                        },
                        {
                            path: 'http://themes.pixelstrap.com/multikart/front-end/email-order-success-two.html',
                            title: 'order-success-2',
                            type: 'extTabLink'
                        },
                        {
                            path: 'http://themes.pixelstrap.com/multikart/front-end/email-template.html',
                            title: 'email-template',
                            type: 'extTabLink'
                        },
                        {
                            path: 'http://themes.pixelstrap.com/multikart/front-end/email-template-two.html',
            ...
            title: 'home', type: 'sub', active: false, children: [
                {
                    title: 'account', type: 'sub', active: false, children: [
                        ...
                        {path: '/home/register', title: 'register', type: 'link'},
                        {path: '/pages/contact', title: 'contact', type: 'link'},
                        {path: '/pages/forget/password', title: 'forget-password', type: 'link'},
                        {path: '/home/profile', title: 'profile', type: 'link'},
                        {path: '/pages/checkout', title: 'checkout', type: 'link'},
                    ]
                },
                {path: '/pages/aboutus', title: 'about-us', type: 'link'},
                {path: '/home/search', title: 'search', type: 'link'},
                {path: '/home/typography', title: 'typography', type: 'link', badge: true, badgeText: 'new'},
                {path: '/home/review', title: 'review', type: 'link', badge: true, badgeText: 'new'},
                {path: '/home/order/success', title: 'order-success', type: 'link'},
                {
